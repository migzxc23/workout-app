...
// Objects are accessible throughout the entire workspace
...
object Constants {
    ...
    fun defaultExerciseList(): ArrayList<ExerciseModel>{
        ...
        val abdominalCrunch = ExerciseModel(4,
            ...
            false,
            false,
            "Get ready for. Abdominal Crunch."
        )
        ...
        val stepUpOnChair = ExerciseModel(5,
                ...
                false,
                false,
            "Get ready for. Step-Up onto Chair."
            )
        ...
        val tricepDipOnChair = ExerciseModel(7,
                ...
                false,
                false,
            "Get ready for. Tricep Dip On Chair."
            )
        ...
        val highKneesRunningInPlace = ExerciseModel(9,
            "High Knees Running In Place",
                ...
                false,
                false,
            "Get ready for. High Knees Running In Place."
            )
        ...
        val pushupAndRotation = ExerciseModel(11,
                ...
                false,
                false,
            "Get ready for. Push up and Rotation."
            )
